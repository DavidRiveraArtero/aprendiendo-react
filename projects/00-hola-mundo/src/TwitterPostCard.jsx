                ...
                <div className="tw-postCard-content">
                    ...
                    <div className="tw-postCard-buttons ">
                        <button onClick={like} className="tw-postCard-buttonHearth tw-postCard-buttons-noStyle">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-heart-fill button-heart" viewBox="0 0 16 16">
                        ...
                        <button onClick={button_retw} className="tw-postCard-buttons-noStyle">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-skip-backward button-retwet" viewBox="0 0 16 16">
